...
{
    public partial class EditEventMasaDay : UserControl
    {
        public EditEventMasaDay()
        {
            InitializeComponent();
        ...
        public void setEvent(GCFestivalMasaDay ev)
        {
            comboBox1.SelectedIndex = ev.nTithi;
            comboBox2.SelectedIndex = ev.nMasa;
        }

        public bool updateEvent(GCFestivalMasaDay ev)
        {
