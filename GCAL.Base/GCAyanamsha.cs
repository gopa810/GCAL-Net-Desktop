...
namespace GCAL.Base
{
    public class GCAyanamsha
    {
        public static int ayamashaType = 1;
        ...
        public static string GetAyanamsaName(int nType)
        {
            if (nType > 3)
                return "";
        ...
        public static int GetAyanamsaType()
        {
        ...
        public static int SetAyanamsaType(int i)
        {
